...
// ---------------------------------------------------------------------------
//	�g�p���� Z80 �G���W���̎�ނ����߂�
//	�W���ł� C++ �ł� Z80 �G���W���� Release �łł̓R���p�C�����Ȃ��ݒ��
//	�Ȃ��Ă���̂Œ��ӁI
//
#ifdef USE_Z80_X86
  #define 	CPU_Z80X86			// x86 �ł� Z80 �G���W�����g�p����
#endif
//#define 	CPU_TEST			// 2 �� Z80 �G���W�����r���s����
//#define 	CPU_DEBUG			// Z80 �G���W���e�X�g�p
...
public:
	enum SpecialPort
	{
		...
		popnio,			// OPN �̓��o�̓|�[�g 1
		popnio2,		// OPN �̓��o�̓|�[�g 2 (�A��)
		psioin,			// SIO �֌W
		psioreq,
		ptimesync,
		portend
	...
	enum SpecialPort2
	{
		...
		pirq2,
		piac2,
		pfdstat,		// FD �̓���� (b0-1 = LAMP, b2-3 = MODE, b4=SEEK)
		portend2
	};
