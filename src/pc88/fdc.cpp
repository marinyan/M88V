...
//	CB  = idlephase �ȊO
//	NDM = E-Phase
//	DIO = 0 �Ȃ� CPU->FDC (Put)  1 �Ȃ� FDC->CPU (Get)
//	RQM = �f�[�^�̑��M�E��M�̗p�ӂ��ł���
//
...
// ---------------------------------------------------------------------------
//	R/W DATA �n resultphase (ST0/ST1/ST2/C/H/R/N)
...
void FDC::CmdScanEqual()
{
	...
	case commandphase:
		GetSectorParameters();
		dtl = dtl | 0x100;		// STP �p�����[�^�DDTL �Ƃ��Ė����Ȓl��������D
...
void FDC::CmdWriteData()
{
	...
	case execwritephase:
		...
		SetTimer(executephase, 500);		// ���ۂ� CRC, GAP �̏������݂��I���܂ŗP�\������͂�
		return;
