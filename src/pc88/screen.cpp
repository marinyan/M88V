...
{
	// 53 53 53 GR TX  80 V2 32 CL  53 53 53 L4 (b4�`b6�̔z�u�͕ς��Ȃ�����)
	...
	else
	{
		...
		case 2:										  break; //	V1 320x200 �͏��COLOR�Ȃ̂�B&W�͑��݂��Ȃ�
...
void IOCALL Screen::Out53(uint, uint data)
{
	...
	else if (port33 & 0x80)
	{
		...
		port53 = data;	//	��ʃ��[�h���ύX�����\���ɔ����C�l�͏�ɑS�r�b�g�ۑ�
	}
}
...
//	Table �쐬
//
packed Screen::BETable0[1 << sizeof(packed)] = { (packed)-1 };
